...
CREATE TABLE `arcade` (
  ...
  PRIMARY KEY (`GameID`),
  KEY `AreaID` (`AreaID`),
  CONSTRAINT `arcade_ibfk_1` FOREIGN KEY (`GameID`) REFERENCES `attraction` (`AttractionID`),
  CONSTRAINT `arcade_ibfk_2` FOREIGN KEY (`AreaID`) REFERENCES `area` (`AreaID`),
  CONSTRAINT `arcade_chk_1` CHECK ((`BuildingCapacity` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dining` (
  ...
  CONSTRAINT `dining_ibfk_1` FOREIGN KEY (`Location`) REFERENCES `area` (`AreaID`),
  CONSTRAINT `dining_ibfk_2` FOREIGN KEY (`ManagerID`) REFERENCES `manager` (`ManagerID`),
  CONSTRAINT `dining_chk_1` CHECK ((`Capacity` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shows` (
  ...
  PRIMARY KEY (`ShowID`),
  CONSTRAINT `shows_ibfk_1` FOREIGN KEY (`ShowID`) REFERENCES `attraction` (`AttractionID`),
  CONSTRAINT `shows_chk_1` CHECK ((`SeatingCapacity` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-05 21:02:49
